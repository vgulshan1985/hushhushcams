	                        	...
	                        	<table valign="top">
									...
									<tr>
										<td colspan="2" style="padding-bottom:15px;">
											...
											3 - Now, add the exact text <b style="font:arial 8px none; color:#da2424"> [rumbletalk-chat] </b>to your visual editor where you want your chat to show.
										</td>
									</tr>
									<tr>
									  ...
									  <td colspan="2" style="padding-bottom:15px;">
										  <table>
											  ...
											  <tr>
												  ...
												  <td style="padding-left:5px;">
													  Add the text <b style="font:arial 8px none; color:#da2424">&#91;rumbletalk-chat&#93; </b>
							...
							<div style="width:500px;">
								<table>
									<tr>
										...
										<td style="padding-left:5px;">
											<span style="font:arial; font-size:14px;color:#da2424">Troubleshooting</span> <br/>
										</td>
									</tr>
									<tr>
							...
							<div style="width:500px;">
								<table style="padding-top:20px;">
									<tr>
										...
										<td style="padding-left:5px;">
											<span style="font:arial; font-size:14px;color:#da2424">Worpress Hosted</span> <br/>
										</td>
									</tr>
									<tr>
										<td colspan="2" style="padding-left:5px;padding-top:10px;">
